...
import { IMyDpOptions, IMyDateModel, MyDatePickerModule } from 'mydatepicker';
...
export class HomeComponent implements OnInit {
    ...
    public onDateChanged(event: IMyDateModel) {
        ...
        this.dateChanged = moment(event.formatted).format('yyyy-mm-dd')
                        ...
                        this.personService.selectDepartOne(this.code_depart)
                            .then((result: any) => {
                                if (result.ok) {
                                    ...
                                    this.dep_res_one = this.departs[0].id_depart;
                                    this.dep_res_group = this.departs[0].code_depart;
                                    this.incidentService.getSelectShowIn(this.dep_res_one, this.dep_res_group)
                                        .then((resultO: any) => {
                                            // console.log(resultO);
                        ...
                        this.personService.selectDepart(this.code_depart, this.quality)
                            .then((result: any) => {
                                if (result.ok) {
                                    ...
                                    this.dep_res_one = this.departs[0].id_depart;
                                    this.dep_res_two = this.departs[1].id_depart;
                                    this.dep_res_group = this.departs[0].code_depart;
                                    this.incidentService.getSelectShowInraw(this.dep_res_one, this.dep_res_two, this.dep_res_group)
                                        .then((resultO: any) => {
                                            // console.log(resultO);
                                            if (resultO.rows.length > 0) {
                                                if (resultO.ok) {
                        ...
                        this.personService.selectDepartOne(this.code_depart)
                            .then((result: any) => {
                                if (result.ok) {
                                    ...
                                    this.incidentService.getSelectIn(this.dep_res_one, this.dep_res_group)
                                        .then((resultO: any) => {
                                            // console.log(resultO);
                                            if (resultO.rows.length > 0) {
                                                if (resultO.ok) {
                        ...
                        this.personService.selectDepart(this.code_depart, this.quality)
                            .then((result: any) => {
                                if (result.ok) {
                                    ...
                                    this.dep_res_two = this.departs[1].id_depart;
                                    this.dep_res_group = this.departs[0].code_depart;
                                    this.incidentService.getSelectInraw(this.dep_res_one, this.dep_res_two, this.dep_res_group)
                                        .then((resultO: any) => {
                                            // console.log(resultO);
                                            if (resultO.rows.length > 0) {
                                                if (resultO.ok) {
